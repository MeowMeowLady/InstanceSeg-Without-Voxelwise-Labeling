...
from modeling.roi_xfrom.roi_align_3d.functions.roi_align_3d import RoIAlignFunction_3d
...
def get_func(func_name):
    ...
    try:
        ...
        if len(parts) == 1:
            return globals()[parts[0]] #return the dictionary of global parameters
    ...
    def roi_feature_transform(self, blobs_in, rpn_ret, blob_rois='rois', method='RoIPoolF',
        ...
        if isinstance(blobs_in, list):
            ...
            for lvl in range(k_min, k_max + 1):
                ...
                if len(rpn_ret[bl_rois]):
                    ...
                    if method == 'RoIPoolF':
                        ...
                        xform_out = RoIAlignFunction_3d(
                            resolution, resolution, resolution, sc, sampling_ratio)(bl_in, rois)
                    bl_out_list.append(xform_out)

            # The pooled features from all levels are concatenated along the
            # batch dimension into a single 5D tensor.
            ...
            if method == 'RoIPoolF':
                ...
                xform_out = RoIAlignFunction_3d(
                    resolution, resolution, resolution, spatial_scale, sampling_ratio)(blobs_in, rois)
