...
# compile roi_align_3d (based on Caffe2's implementation)
cd ../../../
cd modeling/roi_xfrom/roi_align_3d/src
echo "Compiling roi align kernels(3d) by nvcc..."
nvcc -c -o roi_align_kernel_3d.cu.o roi_align_kernel_3d.cu \
	 -D GOOGLE_CUDA=1 -x cu -Xcompiler -fPIC $CUDA_ARCH
cd ../
python build.py
